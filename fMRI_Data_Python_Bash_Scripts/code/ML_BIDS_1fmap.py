...
def infotodict(seqinfo):
    ...
    phase_other = create_key('sub-{subject}/fmap/sub-{subject}_phasediff')
    mag_other = create_key('sub-{subject}/fmap/sub-{subject}_magnitude')
    ...
    for s in seqinfo:
        ...
        * image_type
        ...
        if ('gre_field_mapping' == s.series_description) and ('ND' in s.series_description):   
